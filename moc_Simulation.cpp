...
QT_MOC_LITERAL(3, 27, 15), // "slot_nb_animaux"
QT_MOC_LITERAL(4, 43, 18), // "slot_setProportion"
QT_MOC_LITERAL(5, 62, 12), // "slot_vitesse"
QT_MOC_LITERAL(6, 75, 15), // "slot_setEnergie"
QT_MOC_LITERAL(7, 91, 15), // "slot_setTailleX"
QT_MOC_LITERAL(8, 107, 15), // "slot_setTailleY"
QT_MOC_LITERAL(9, 123, 15), // "slot_simulation"
QT_MOC_LITERAL(10, 139, 6) // "update"

    },
    "Simulation\0signal_valeurs\0\0slot_nb_animaux\0"
    "slot_setProportion\0slot_vitesse\0"
    "slot_setEnergie\0slot_setTailleX\0"
    "slot_setTailleY\0slot_simulation\0update"
};
...
void Simulation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_valeurs((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4])),(*reinterpret_cast< int(*)>(_a[5]))); break;
        case 1: _t->slot_nb_animaux((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slot_setProportion((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->slot_vitesse((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->slot_setEnergie((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->slot_setTailleX((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->slot_setTailleY((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: _t->slot_simulation(); break;
        ...
        {
            typedef void (Simulation::*_t)(int , int , int , int , int );
...
// SIGNAL 0
void Simulation::signal_valeurs(int _t1, int _t2, int _t3, int _t4, int _t5)
{
